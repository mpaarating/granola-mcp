...
# Make the `granola_mcp` package importable when run from the repo root.
sys.path.insert(0, str(Path(__file__).resolve().parent))

from granola_mcp.auth import AUTH_FILE, GranolaAuthError, set_refresh_token  # noqa: E402
